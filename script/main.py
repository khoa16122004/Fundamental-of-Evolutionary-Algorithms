...
if __name__ == "__main__":
    ...
    parser.add_argument("--algorithm", type=str, default="GA", choices=[ "GA", "DE", "PSO", "DE_vectorize"])
    ...
    elif args.algorithm == "DE_vectorize":
        best_solution, best_value, history = DE_vectorize(func=func, bounds=bounds,
                                                          pop_size=args.pop_size,
                                                          F=args.F,
                                                          CR=args.CR,
                                                          max_iter=args.max_iter)
